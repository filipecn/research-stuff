...
Saxpby(SPGrid_Allocator <T_STRUCT, d> &allocator,
       const std::pair<const unsigned long *, unsigned> &blocks,
       T_FIELD T_STRUCT::* x_field,
       T_FIELD T_STRUCT::* y_field,
       const T_FIELD alpha,
       const T_FIELD beta,
...
Masked_Saxpby(SPGrid_Allocator <T_STRUCT, d> &allocator,
              const std::pair<const unsigned long *, unsigned> &blocks,
              T_DATA T_STRUCT::* x_field,
              T_DATA T_STRUCT::* y_field,
              const T_DATA alpha,
              const T_DATA beta,
