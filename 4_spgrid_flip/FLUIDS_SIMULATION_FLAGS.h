...
enum {
  ...
  SPGrid_Cell_Type_Active =
  0x00000008u, // Active = Interior but not Dirichlet, also not fully surrounded by Neumann faces
  ...
  SPGrid_Face_Type_X_Active =
  0x00000080u, // Active faces are initialized to be all the valid faces that don't touch exterior cells
  SPGrid_Face_Type_Y_Active =
  0x00000100u, // These flags can be overridden by user, to specify additional Neumann regions
